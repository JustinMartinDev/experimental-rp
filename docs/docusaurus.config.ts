...
const config: Config = {
  ...
  tagline: "A TypeScript resource for FiveM RP servers",
  favicon: "img/favicon.ico",

  // Set the production url of your site here
  url: "https://justinmartindev.github.io",
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: "/experimental-rp/",

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: "justinmartindev", // Usually your GitHub org/user name.
  projectName: "experimental-rp", // Usually your repo name.
  trailingSlash: false,

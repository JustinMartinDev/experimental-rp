!(function () {
  ...
  function w(n) {
    ((!n.__d && (n.__d = !0) && i.push(n) && !C.__r++) ||
      o !== l.debounceRendering) &&
      ((o = l.debounceRendering) || r)(C);
  }
  function C() {
    var n, l, u, t, o, r, f, c;
  ...
  function x(n, l, u, t, i, o, r, e, f, c) {
    ...
    for (u.__k = [], h = 0; h < l.length; h++)
      if (
        null !=
        (y = u.__k[h] =
          null == (y = l[h]) || "boolean" == typeof y || "function" == typeof y
            ? null
            : "string" == typeof y ||
                "number" == typeof y ||
                "bigint" == typeof y
              ...
              : v(y)
                ...
                : y.__b > 0
                  ? _(y.type, y.props, y.key, y.ref ? y.ref : null, y.__v)
                  : y)
      ) {
        if (
          ((y.__ = u),
        ...
        j(n, y, (p = p || s), i, o, r, e, f, c),
          ...
          null != k
            ...
            : f && p.__e == f && f.parentNode != n && (f = b(p));
      }
    for (u.__e = g, h = x; h--; )
      null != C[h] &&
        ("function" == typeof u.type &&
          null != C[h].__e &&
          C[h].__e == u.__d &&
          (u.__d = E(t).nextSibling),
        M(C[h], C[h]));
    if (w) for (h = 0; h < w.length; h++) L(w[h], w[++h], w[++h]);
  }
  function P(n, l, u) {
    for (var t, i = n.__k, o = 0; i && o < i.length; o++)
      (t = i[o]) &&
        ((t.__ = n),
        (l =
          "function" == typeof t.type ? P(t, l, u) : A(u, t, t, i, t.__e, l)));
    return l;
  }
  ...
  function $(n, l, u) {
    "-" === l[0]
      ...
      : (n[l] =
          null == u ? "" : "number" != typeof u || h.test(l) ? u : u + "px");
  }
  function H(n, l, u, t, i) {
    ...
    n: if ("style" === l)
      ...
      (o = l !== (l = l.replace(/Capture$/, ""))),
        ...
        (n.l[l + o] = u),
        u
          ? t || n.addEventListener(l, o ? T : I, o)
      ...
      n: if ("function" == typeof H) {
        ...
        (a.state = a.__s),
          ...
          h ||
            ...
            (_ = a.getSnapshotBeforeUpdate(p, y)),
          x(
            n,
            v(
              ($ =
  ...
  function F(l, u, t, i, o, r, e, f) {
    ...
    if (null === _) d === y || (f && l.data === y) || (l.data = y);
    else {
      if (
      ...
      f ||
        ("value" in y &&
          ...
          (m !== l.value ||
            ("progress" === _ && !m) ||
            ("option" === _ && m !== d.value)) &&
          H(l, "value", m, d.value, !1),
        "checked" in y &&
          void 0 !== (m = y.checked) &&
          m !== l.checked &&
          H(l, "checked", m, d.checked, !1));
    }
    return l;
  }
  function L(n, u, t) {
      ...
      cloneElement: function (l, u, t) {
        ...
        u))
          "key" == r
            ...
            : "ref" == r
              ? (o = u[r])
              : (f[r] = void 0 === u[r] && void 0 !== e ? e[r] : u[r]);
        return (
          arguments.length > 2 &&

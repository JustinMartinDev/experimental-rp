...
INSERT INTO "new_Ped" ("actionId", "actionParam", "id", "locationId", "name", "organizationId", "radius") SELECT "actionId", "actionParam", "id", "locationId", "name", "organizationId", "radius" FROM "Ped";
DROP TABLE "Ped";
